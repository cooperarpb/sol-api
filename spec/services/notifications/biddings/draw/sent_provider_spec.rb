...
RSpec.describe Notifications::Biddings::Draw::SentProvider, type: [:service, :notification] do
  ...
  let!(:proposal_2) { create(:proposal, bidding: bidding, status: :draw) }
  ...
  describe 'call' do
    ...
    describe 'notification' do
      ...
      it { expect(notification.action).to eq 'bidding.draw_sent_provider' }
