...
RSpec.describe Notifications::Biddings::Reproved, type: [:service, :notification] do
  let!(:bidding)    { create(:bidding, kind: :global, status: :draft) }
  ...
  describe 'call' do
    ...
    describe 'notification' do
      ...
      it { expect(notification.action).to eq 'bidding.reproved' }
