...
RSpec.describe Notifications::Biddings::CancellationRequests::Reproved, type: [:service, :notification] do
  ...
  describe 'call' do
    ...
    describe 'notification' do
      ...
      it { expect(notification.action).to eq 'bidding.cancellation_request_reproved' }
