...
RSpec.describe Notifications::Biddings::Finished, type: [:service, :notification] do
  ...
  describe 'call' do
    ...
    describe 'notifications' do
      ...
      describe 'I18n' do
        ...
        let(:title_msg) { "Licitação #{bidding.title} concluída." }
        ...
        let(:body_msg) do
          "A licitação <strong>#{bidding.title}</strong> foi concluida com sucesso!"
        end
      ...
      describe 'admin notification' do
        ...
        it { expect(notification.action).to eq 'bidding.finished' }
