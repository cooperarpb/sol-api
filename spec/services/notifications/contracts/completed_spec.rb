...
RSpec.describe Notifications::Contracts::Completed, type: [:service, :notification] do
  ...
  describe '.call' do
    ...
    describe 'notification' do
      ...
      describe 'admin notification' do
        ...
        it { expect(notification.action).to eq 'contract.completed' }
        ...
        describe 'I18n' do
          let(:title_msg) { 'Contrato concluído.' }
          let(:body_msg) do
