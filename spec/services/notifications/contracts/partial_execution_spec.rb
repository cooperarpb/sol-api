...
RSpec.describe Notifications::Contracts::PartialExecution, type: [:service, :notification] do
  ...
  describe '.call' do
    ...
    describe 'notification' do
      ...
      describe 'admin notification' do
        ...
        it { expect(notification.action).to eq 'contract.partial_execution' }
