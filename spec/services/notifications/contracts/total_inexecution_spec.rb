...
RSpec.describe Notifications::Contracts::TotalInexecution, type: [:service, :notification] do
  ...
  describe '.call' do
    ...
    describe 'notification' do
      ...
      describe 'admin notification' do
        ...
        it { expect(notification.action).to eq 'contract.total_inexecution' }
