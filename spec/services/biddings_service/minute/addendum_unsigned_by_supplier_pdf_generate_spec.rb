...
RSpec.describe BiddingsService::Minute::AddendumUnsignedBySupplierPdfGenerate, type: :service do
  ...
  let!(:contract) do
    create(:contract, proposal: proposal, status: :unsigned_by_supplier, user: user, user_signed_at: DateTime.current)
  end
  ...
  describe '.call!' do
    ...
    before do
      allow(Pdf::Bidding::Minute::Addendum::UnsignedBySupplierHtml).
